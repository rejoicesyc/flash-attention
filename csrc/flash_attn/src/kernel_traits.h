...
template<int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, bool Is_Q_in_regs_=false, bool Share_Q_K_smem_=false, typename elem_type=cutlass::half_t, bool Is_DCA_fwd_=false, bool uniform_softmax_=false,
...
struct Flash_fwd_kernel_traits : public Base {
    ...
    static constexpr bool Is_DCA_fwd = Is_DCA_fwd_;
    static constexpr bool uniform_softmax = uniform_softmax_;
    ...
    static constexpr int kSmemQSize = size(SmemLayoutQ{}) * sizeof(Element) * ((Is_DCA_fwd && !uniform_softmax) ? 3 : 1);
