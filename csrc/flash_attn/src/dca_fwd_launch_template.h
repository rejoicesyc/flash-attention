...
#define DEFINE_FLASH_DCA_FORWARD_KERNEL(kernelName, ...) \
...
DEFINE_FLASH_DCA_FORWARD_KERNEL(dca_fwd_splitkv_kernel, bool Is_causal, bool Is_local, bool Has_alibi, bool Is_even_MN, bool Is_even_K, bool Is_softcap, bool Split, bool Append_KV) {
    #if defined(ARCH_SUPPORTS_FLASH)
        flash::compute_dca_splitkv<Kernel_traits, Is_causal, Is_local, Has_alibi, Is_even_MN, Is_even_K, Is_softcap, Split, Append_KV>(params);
    #else
        FLASH_UNSUPPORTED_ARCH
    #endif
}
                    ...
                    BOOL_SWITCH(params.knew_ptr != nullptr, Append_KV, [&] {
                        ALIBI_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                            SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                                ...
                                // If not IsEvenKConst, we also set IsEvenMNConst to false to reduce number of templates.
                                // If Is_local, set Is_causal to false
                                auto kernel = &dca_fwd_splitkv_kernel<Kernel_traits, Is_causal, Is_local && !Is_causal, Has_alibi, IsEvenMNConst && !Append_KV && IsEvenKConst && !Is_local && Kernel_traits::kHeadDim <= 128, IsEvenKConst, Is_softcap, Split, Append_KV>;
...
void run_mha_fwd_hdim32(Flash_dca_fwd_params &params, cudaStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_fwd_hdim64(Flash_dca_fwd_params &params, cudaStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_fwd_hdim96(Flash_dca_fwd_params &params, cudaStream_t stream) {
...
/*
template<typename T, bool Is_causal>
void run_mha_fwd_hdim160(Flash_dca_fwd_params &params, cudaStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_fwd_hdim192(Flash_dca_fwd_params &params, cudaStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_fwd_hdim256(Flash_dca_fwd_params &params, cudaStream_t stream) {
